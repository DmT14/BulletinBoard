...
<body>
    ...
    <div id="categories">
        ...
        <div id="chosen" class="categories"><p>Одежда</p></div>
    ...
    <div id="content">
        ...
        <?php
            ...
            $result = $mysql->query("SELECT * FROM `advertisment` WHERE `advertisment_category` = 5 AND `advertisment_type` = 1 AND DATEDIFF(CURRENT_DATE(), `date`)  < 21 AND  (`for_who` = '' OR `for_who` IS NULL)");
